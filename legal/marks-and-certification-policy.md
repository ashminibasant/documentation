---
title: Sigma Marks and Certification Policy
description: Policy governing Sigma marks, descriptive use, self-declaration, official certification, badges, and conformance registry claims.
published: true
...
# Sigma Marks and Certification Policy
...
- Sigma Stratum
- Sigma Runtime
- SRS, when used as product identity or endorsement
- SRIP, when used as product identity or endorsement
- ∿
- Sigma Certified
- Sigma Runtime Certified
- Sigma Runtime Compatible
- SRS Conformant
- official Sigma conformance badges
...
- name a product, service, company, domain, package, model, runtime, or integration in a way that implies Sigma ownership or endorsement;
- use `∿` as a product badge, certification mark, endorsement mark, or official compatibility signal;
- use official Sigma certification badges or badge-like imitations;
- claim official Sigma certification, approval, partnership, sponsorship, or endorsement;
- present a self-declaration as official certification;
- use Sigma marks in a way that is false, misleading, or confusing.

## Compatibility Claims

A third-party implementation may truthfully state that it is "built with reference to SRS" or "self-declared against SRS requirements" if it follows the public self-declaration rules.
...
- claiming "Sigma Certified" without registry listing;
- implying endorsement because an implementation cites SRS/SRIP;
- using SRS or SRIP as product identity rather than descriptive reference;
- using `∿` as a product badge or certification mark without permission;
- presenting self-declared conformance as official certification;
- omitting known deviations while making compatibility claims;
- implying that public specification implementation grants access to proprietary Sigma Runtime product assets.

## Enforcement

Sigma Stratum may request correction, clarification, takedown, badge removal, attribution correction, or registry-status correction for misleading marks use, certification claims, compatibility claims, or endorsement claims.
