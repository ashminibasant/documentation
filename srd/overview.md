...
This SRD document explains the public SRS/SRIP specification layer. It does not license or disclose proprietary Sigma Runtime implementation assets unless explicitly marked.
...
1. **Field Layer (Cognitive Field Engine)**
   ...
   - Attractor State and symbolic topology
   - Symbolic Density and **Semantic Compression Ratio (SCR)**
   - Drift Metrics and Continuity Indices
...
3. **Memory Layer**
   ...
   - Episodic traces (cycle-level states)
   - Semantic embeddings (conceptual graph)
   - Symbolic motif stores (archetypal and structural signatures)
