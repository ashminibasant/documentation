...
| 01 Runtime Loop | Runtime continuation | Interaction input and runtime state | Ordered cycle and feedback closure | Safety and governance can block transitions |
...
| 20 ANS | Autonomy and influence boundary control | Influence, consent, delegation, and identity evidence | Negotiated boundary state and pressure handling | Safety and legitimate governance precedence |
...
| 22 GRC | Governance legitimacy and capture boundary | Authority, evidence, certification, and collusion assumptions | Legitimacy state, contestability, suspension, and fork/exit conditions | Safety remains non-bypassable; proof alone is not legitimacy |
...
| 24 EIL | Environment observation/effect boundary | External contact and runtime intent | Classified interaction with authority and evidence context | Effects require authorization; observation is not effect |
| 25 IEM | Transport-independent event semantics | Environment interactions | Typed observation/effect events and traces | Memory and governance rules apply to event consequences |
...
| 28 TAL | Pre-persistence candidate admission | TMC membership, AEP dynamics, boundary state, lineage, and recovery evidence | Admit, hold, reject, boundary-only, or contain-review transaction | Single writer for delivery; held/rejected candidates cannot influence accepted state |
