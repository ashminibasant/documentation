...
8. Contradiction is buffered when valid states cannot yet be reconciled
   (`SRIP-19`).
9. Controlled perturbation or dialectical generation may propose bounded
   alternatives (`SRIP-15`, `SRIP-23`).
10. Any external effect returns through an authorized environment event
    (`SRIP-24`, `SRIP-25`).
...
6. When may generated candidates become canonical state?
